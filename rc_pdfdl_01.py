...
class gsearch:
    ...
    def urlq(self):
        ...
        for row in csvd:
            ...
            cityurl = 'filetype:pdf Township of '+ city + ' New Jersey recreational marijuana municipal ordinance after:2021-04-01 before:2021-09-01'
    ...
    def dlfile(self, town):
        print('from gglsearch')
        ttown=town['town']  
        link = town['link']
        fname = str(ttown) + '_ordinance.pdf'
        f = open(fname, 'wb')
        r = requests.get(link)
        print('after requests call')
        ...
        for r in result:
            ...
            if lcount > 0:
                ...
                try:
                    ...
                    # self.dlfile(rdict)
                    print('sent to dlfile')
                    
                    
                except Exception as e:
                    print(e)
                    print(result)
                    print('link or download error')
                    rdict =  {'error':e}
